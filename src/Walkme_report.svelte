<script>
    ...
    const fluffWords = [
        "fluff","am", "by", "no", "fill", "who", "cannot", "please", "difficult", "nothing", "or", "off", "cant", "someone", "and", "other", "the", "my", "at", "as", "in", "you", "get", "what", "is", "do", "an", "of", "not", "have", "to", "view", "this", "type", "how", "off", "on", "if", "i", "when", "want", "why", "line", "a", "can", "for"
    ];
